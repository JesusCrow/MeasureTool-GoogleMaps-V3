...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectAll__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__merge__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__order__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sort__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__call__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__nodes__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__node__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__size__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__empty__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__each__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__attr__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__property__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__classed__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__html__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__raise__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__lower__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__append__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__insert__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__remove__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__clone__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__datum__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__on__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__dispatch__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_create__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_creator__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_local__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_matcher__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_mouse__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_namespace__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_namespaces__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_point__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_select__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_selectAll__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_selector__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_selectorAll__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_selection_style__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_touch__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_touches__ = __webpack_require__(75);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_window__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_selection_on__ = __webpack_require__(8);
...
var _contextMenu = __webpack_require__(76);
...
exports.default = {
  EVENT_START: 'measure_start',
  EVENT_END: 'measure_end',
  EVENT_CHANGE: 'measure_change',
  EVENT_TICK: 'measure_tick'
};
module.exports = exports['default'];
  ...
  if (coordinates) {
    if (coordinates.constructor === Array) {
      if (coordinates.some(function (coord) {
        return coord && coord.constructor === Number;
      })) {
        accumulator.push(coordinates);
      } else {
        coordinates.forEach(function (coords) {
          accumulator.concat(flattenCoordinates(coords, accumulator));
        });
      }
    }
  }
...
exports.default = flattenCoordinates;
module.exports = exports["default"];
...
var Helper = function () {
  ...
  _createClass(Helper, [{
    ...
    key: 'computePosition',
    value: function computePosition(points) {
      var bounds = new google.maps.LatLngBounds();
      points.forEach(function (p) {
        var coordinate = new google.maps.LatLng(p[1], p[0]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_drag__ = __webpack_require__(40);
...
var _polyfills = __webpack_require__(27);

var _flattenCoordinates = __webpack_require__(24);

var _flattenCoordinates2 = _interopRequireDefault(_flattenCoordinates);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    key: 'start',
    value: function start(coordinates) {
      var _this2 = this;
      ...
      if (coordinates && coordinates.constructor === Array && coordinates.length > 0) {
        (0, _flattenCoordinates2.default)(coordinates).forEach(function (node) {
          return _this2._geometry.addNode(node);
        });
      }
    ...
    value: function end() {
      ...
      var coordinates = this._geometry.nodes;
      this._geometry = new _geometry.Geometry();
    ...
    key: '_emitTick',
    value: function _emitTick() {
      if (typeof this._events.get(_events.EVENT_TICK) === "function") {
        var data = {
          result: {
            length: this.length,
            area: this.area,
          ...
          // this._lastTickID = newTickID;
        };this._events.get(_events.EVENT_TICK)(data);
      }
    }
  }, {
    key: '_initOverlay',
    ...
    value: function _onDrawOverlay() {
      ...
      if (this._geometry) {
        ...
        this._updatePosition(this._geometry.nodes.length - 1, this._geometry.nodes[this._geometry.nodes.length - 1]);
      }
    ...
    value: function _onDragCircle() {
      ...
      var circleDrag = (0, _d3Drag.drag)().on('drag', function (d, i) {
        ...
        self._updateArea(i, self._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
        self._updatePosition(i, self._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
      });
    ...
    value: function _onDragLine() {
      ...
      var lineDrag = (0, _d3Drag.drag)().on('drag', function (d, i) {
        ...
        _this7._updatePosition(i + 1, _this7._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
      });
    ...
    key: '_updatePosition',
    value: function _updatePosition(i, pointToCompare) {
    ...
    value: function _updateArea(i, pointToCompare) {
      ...
      if (n > 2) {
        var nodes = this._geometry.nodes;
        if (i && pointToCompare) nodes[i] = pointToCompare;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(38);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_dispatch__ = __webpack_require__(37);
